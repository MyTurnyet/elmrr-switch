...
export class TrainTransformer extends BaseTransformer {
   ...
   * 
   * @param {Object} train - Raw train entity from database
   * @param {Object} options - Transformation options
   * @returns {Object} - Transformed train entity
   */
   ...
   * @private
   */
  _transformLocomotive(locomotive) {
   ...
   */
  static transformStatistics(trains) {
   ...
   */
  static transformSwitchList(switchList) {
