...
export class IndustryTransformer extends BaseTransformer {
  /**
   ...
   * @private
   */
  _transformForDetail(industry, raw) {
    return {
      ...industry,
      // Add computed fields
   ...
   */
  static transformStatistics(industries) {
   ...
   */
  static calculateSessionDemand(industry, sessionNumber) {
